...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_QRC/form05_6_1_ApplyQrCode" target="_blank">
<p>
<label>商户号：</label>
<input id="merId" type="text" name="merId" placeholder="" value="852333053119986" title="默认商户号仅作为联调测试使用，正式上线还请使用正式申请的商户号" required="required"/>
</p>
<p>
<label>订单发送时间：</label>
