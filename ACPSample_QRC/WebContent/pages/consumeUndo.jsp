...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_QRC/form05_6_3_ConsumeUndo" target="_blank">
<p>
<label>商户号：</label>
...
<p>
<label>原交易流水号：</label>
<input id="origQryId" type="text" name="origQryId" placeholder="原交易流水号" value="" title="原交易流水号，从查询或通知接口中获取 " />
</p>
